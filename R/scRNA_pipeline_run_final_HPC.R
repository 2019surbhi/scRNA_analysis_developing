...
# Running IKAP on clustered object #
run_IKAP(obj.integrated, argv$out_dir, verbose=argv$verbose)
...
{
 #Export seurat object for future use
 if(argv$verbose)
...
## Table for cells by cluster by sample 
